...
- [x] 2026-09-17 晚間 Action Plan slice:手機長卡片可讀性先收一刀;引導版與抽屜在小螢幕下降低標題/內文字級,事實卡改單欄,教科書表格可橫向捲動,scrolly 紙張改 58vh 並限制 overscroll;兒童放電計數改成「真實神經細胞的模擬放電」/`simulated firing from real nerve cells`,避免把模擬活動講成實測活動。
