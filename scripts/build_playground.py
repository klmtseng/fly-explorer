...
def readouts(csv_path, grp):
    """每個族群的首次放電時刻(ms)與放電次數,外加總放電數。"""
...
def main():
    ...
    resampled = {
        "dose_155": ("隨機挑一半偵測器(155)", "half the detectors, picked at random (155)", 155, "detectors"),
        "dose_78":  ("隨機挑四分之一(78)", "a quarter of the detectors (78)", 78, "detectors"),
        "dose_39":  ("隨機挑八分之一(39)", "an eighth of the detectors (39)", 39, "detectors"),
        "dose_16":  ("隨機挑十六分之一(16)", "a sixteenth of the detectors (16)", 16, "detectors"),
    ...
    for key, (zh, en, ids) in fixed.items():
        ...
        for s in range(1, a.seeds + 1):
            ...
            runs.append(readouts(run_one(p, s, key), grp))
